...
import {loggedInUser, loggedInactivePractice, loggedInUserGroup, loggedInPermissions,loggedInUserPractices, logInUser, logOutUser} from "./app/utils/auth";
      ...
      // console.log(this.state.active_practiceId);
        return <Layout style={{height: '100px'}}>
            <Switch>
                ...
                <Route render={() => (this.state.user ? <AppBase {...this.state} logout={this.logout} switchPractice={this.switchPractice}/> :
