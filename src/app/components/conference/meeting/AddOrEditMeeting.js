...
class AddOrEditMeeting extends React.Component{
    ...
    addNewUser=()=>{
        let that=this; const { form } = this.props;
                ...
                <Form onSubmit={this.handleSubmit}>
                    ...
                    <Form.Item label={"No. of Participants"} {...formItemLayout}>
                        {getFieldDecorator('participants',{initialValue: '1'})
                            (<InputNumber placeholder={"No. of Participants"} min={1} max={MAX_PARTICIPANT} onChange={(value)=>this.onChangeParticipant(value)}/>)
                        }
                    </Form.Item>
                    ...
                    <Form.Item label={"Booking From"} {...formItemLayout}>
                        {getFieldDecorator('form',{initialValue:that.state.startSchedule?that.state.startSchedule:that.props.startTime})
