...
import {ALL_EXPENSES, DAILY_EXPENSES, EXPENSES_EACH_TYPE, MONTHLY_EXPENSES} from "../../../constants/dataKeys";
                ...
                <Row gutter={16}>
                    <Col span={(24 - this.state.sidePanelColSpan)}>
                        ...
                        {this.state.type == ALL_EXPENSES ?
                            <AllExpensesReport {...this.props} {...this.state}/> : null}

                        {this.state.type == DAILY_EXPENSES ? <DailyExpenses {...this.props} {...this.state}/> : null}

                        {this.state.type == MONTHLY_EXPENSES ?
                            <MonthlyExpenses {...this.props} {...this.state}/> : null}
                        {this.state.type == EXPENSES_EACH_TYPE ?
                            <ExpensesForEachType {...this.props} {...this.state}/> : null}
                    ...
                    <Col span={this.state.sidePanelColSpan}>
                        ...
                        <br/>
                            {this.state.advancedOptionShow?<>
                                ...
                                <Col> <br/>
                                    <h4>Expense Type</h4>
                                    <Select style={{minWidth: '200px'}} mode="multiple" placeholder="Select Expense Type"
                                            onChange={(value)=>this.handleChangeOption('expense_type',value)}>
                                        {this.state.expenseTypeOption.map((item) => <Select.Option value={item.id}>
