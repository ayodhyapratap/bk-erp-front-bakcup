            ...
            <Card>
                <Row gutter={16}>
                    <Col span={16}>
                        ...
                        {this.state.type == EXPIRING_MEMBERSHIP?<ExpiringMembership {...this.props} type={this.state.type}/>:null}
                        {this.state.type == PATIENTS_FIRST_APPOINTMENT?<PatientsFirstAppointment {...this.props} type={this.state.type}/>:null}
                        {this.state.type == MONTHLY_NEW_PATIENTS?<MonthlyNewPatients  {...this.props} type={this.state.type}/>:null}
                        {this.state.type == NEW_MEMBERSHIP ?<NewMembership  {...this.props} type={this.state.type}/>:null}

                    </Col>
                    <Col span={8}>
                        <Radio.Group buttonStyle="solid" defaultValue={NEW_PATIENTS} onChange={(value)=>this.onChangeHandle('type',value)}>
                            <h2>Patients</h2>
