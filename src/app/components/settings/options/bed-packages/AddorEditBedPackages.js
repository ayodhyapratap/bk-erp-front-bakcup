...
export default class AddorEditBedPackages extends React.Component {
    ...
    render() {
        ...
        let fields = [{
            ...
            key: 'normal_price',
            required: true,
            initialValue: this.props.editPackage ? (this.props.editPackage.normal_price + this.props.editPackage.normal_tax_value).toFixed(): null,
            type: NUMBER_FIELD,
            follow: 'INR',
        }, {
            label: "Tatkal Price",
            key: 'tatkal_price',
            required: true,
            initialValue: this.props.editPackage ?(this.props.editPackage.tatkal_price + this.props.editPackage.tatkal_tax_value).toFixed(): null,
            type: NUMBER_FIELD,
            follow: 'INR'
        }, {
            label: "Image",
