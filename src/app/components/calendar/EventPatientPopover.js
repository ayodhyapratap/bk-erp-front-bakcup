...
import {Spin, Row, Col, Avatar, Icon} from "antd";
            ...
            <Spin spinning={this.state.loading}>
                {this.state.appointment ? <div>
                        <Row>
                            ...
                            <Col span={16}>
                                <Link to={"/patient/"+this.state.appointment.patient.id+"/profile"}><h2>{this.state.appointment.patient.user.first_name}</h2>
                                <h4>Patient ID: {this.state.appointment.patient.id} , {this.state.appointment.patient.gender}</h4>
