...
export default class AddItemType extends React.Component {
    ...
    render() {
      ...
      if(this.state.editInventoryItemType!=null){
        return <Row>
              <Card>
                <AddInventoryFormLayout defaultValues={defaultValues} title="Edit Inventory Item type" changeRedirect= {this.changeRedirect} formProp= {editformProp} fields={fields}/>
              </Card>
            ...
            return <Row>
                  <Card>
                    <AddInventoryFormLayout title="Add Inventory Item type"  defaultValues={defaultValues} changeRedirect= {this.changeRedirect} formProp= {formProp} fields={fields}/>
                  </Card>
                    {this.state.redirect&&    <Redirect to={'/inventory'} />}
                    </Row>
                            }
