...
export default class AddOrConsumeStock extends React.Component {
    ...
    render() {
        ...
        let defaultAddValues = [{"key": "inventory_item", "value": this.state.itemId}, {
            "key": "item_add_type",
            "value": this.state.actionType
        }];
        let defaultConsumeValues = [{"key": "inventory_item", "value": this.state.itemId}, {
            "key": "item_add_type",
            "value": this.state.actionType
        }];
        if (this.state.actionType == ADD_STOCK) {
            ...
            return <Row>
                <Card>
                    <AddInventoryFormLayout defaultValues={defaultAddValues} title="Add item Stock"
        ...
        if (this.state.actionType == CONSUME_STOCK) {
            ...
            return <Row>
                <Card>
                    <AddInventoryFormLayout title="Consume Item Stock" defaultValues={defaultConsumeValues}
                                            changeRedirect={this.changeRedirect} formProp={formProp} fields={fields}/>
                </Card>
            </Row>
        }
