...
import {MULTI_SELECT_FIELD, SINGLE_IMAGE_UPLOAD_FIELD, INPUT_FIELD,ERROR_MSG_TYPE, SUCCESS_MSG_TYPE} from "../../../constants/dataKeys";
...
>
            ...
            >
                {this.state.showPDFFile ?
                    <iframe src={makeFileURL(this.state.showPDFFile.file_type)} frameBorder="0" style={{width:'100%',minHeight:'80vh'}} /> : null}
            </Modal>
</Card>
)
